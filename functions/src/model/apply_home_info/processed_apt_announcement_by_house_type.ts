// import { AptAnnouncementDetails } from "../../feature/applyhome/model/apt_announcement_details";


// //TODO 성공 통계 구현?
// /**
//  *  APT 주택형별 상세조회 모델 {@link AptAnnouncementDetails} 을 가공한 정보를 저장하는 클래스 입니다.
//  */
...
//         announcementByHouseTypeList : (AptAnnouncementDetails | null)[],
...
//             if(e.topAmount != null){
//                 //#. 숫자로 변경
//                 const price = Number(e.topAmount);
...
//                 console.log(`[${data.announcementByHouseTypeList[0]?.houseManageNumber}] ${_totalGeneralSupplyHouseholds + _totalSpecialSupplyHouseholds} : ${data.totalSupplyHouseholdCount}`);
//             }
//         }
//         else{
//             console.log(`
//                 [${data.announcementByHouseTypeList[0]?.houseManageNumber}]
//                 _totalGeneralSupplyHouseholds : ${_totalGeneralSupplyHouseholds}
//                 _totalSpecialSupplyHouseholds : ${_totalSpecialSupplyHouseholds}
//                 data.totalSupplyHouseholdCount : ${data.totalSupplyHouseholdCount}
//             `);
